...
class _GraphDetailsState extends State<GraphDetails> {
  ...
  getgraph() async {
    ...
    var graph_1_keys = data['graph_1_key'];
    var graph_1_values = data['graph_1_value'];

    setState(() {
      for (int i = 0; i < graph_1_keys.length; i++) {
        BarGraphData cat = BarGraphData(graph_1_keys[i].toString().substring(0, 6), graph_1_values[i]);
        bar.add(cat);
      }
    });
    series_bar = [
      ...
      child: ShaderMask(
        ...
        shaderCallback: (Rect bounds) {
          return LinearGradient(
            ...
            //colors: [Color(0xFF8A2387), Color(0xFFE94057), Color(0xFFF27121)],//[Color(0xFFFFB540), Color(0xFFFA4169)],Color(0xFF0083B0),
            colors: [Colors.purple[200], Colors.deepPurple[200]],
            // stops: [
            //   0.0,
            //   0.5,
            //   1.0,
  ...
  Widget drawTotalBarGraph() {
    return Padding(
      padding: const EdgeInsets.all(0.0),
      child: Container(
        height: 300,
        width: bar.length > 4 ? screenWidth * 0.9 + (bar.length - 4) * 0.225 : screenWidth * 0.95,
        child: ShaderMask(
          child: charts.BarChart(
            ...
            behaviors: [
              ...
              new charts.ChartTitle('Date',
                  ...
                  titleOutsideJustification:
                      charts.OutsideJustification.middleDrawArea),
              new charts.ChartTitle('No of Violations',
                  behaviorPosition: charts.BehaviorPosition.start,
                  titleOutsideJustification:
                      charts.OutsideJustification.middleDrawArea),
            ],
