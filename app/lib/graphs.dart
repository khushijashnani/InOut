...
class _GraphDetailsState extends State<GraphDetails> {
  ...
  List<dynamic> graph_1_keys = [];
  List<dynamic> graph_2_keys = [];
  List<dynamic> graph_3_keys = [];
  List graph_1_values = [];
  List graph_2_values = [];
  List graph_3_values = [];
  List<GraphData> mask_line = [];
  List<GraphData> sd_line = [];
  ...
  getgraph() async {
    var response =
        await http.get('https://c680f43c9351.ngrok.io/graph_details');
    ...
    setState(() {
      for (int i = 0; i < graph_2_keys.length; i++) {
        ...
        GraphData obj = GraphData(i, graph_2_values[i]);
        mask_line.add(obj);
      }
